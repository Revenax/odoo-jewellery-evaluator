...
class TestRouter:
    ...
    def test_pear_uses_pear_grid(self):
        assert get_stone_price_usd(_env, "Pear", 1.20, "G", "VS1") == 4800.0

    def test_other_shape_uses_round_grid(self):
        assert get_stone_price_usd(_env, "Oval", 1.20, "G", "VS1") == 6480.0
